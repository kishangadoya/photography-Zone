...
<div class="header">
    ...
    <a href="index.php" class="a" style="margin-right: 8px;font-size: 20px;">Log In <i class="fa fa-sign-out" style="font-size: 18px"></i></a> <span style="float: right;margin-top: 5px;color: lightgrey;">Already have an account?&nbsp;&nbsp;</span>
</div>
