...
<!--		***************			FORM START  ********8****          -->
 <div class="middle comman">
				<form name="fm" method="post" action="formprocess.php">
...
<!-- *************************************************-->
		...
		<input type="radio" name="Gender" value="Male" style="cursor: pointer;">Male
	 	...
	 	<input type="reset" value="Reset" name="Reset"  class="btn" style="margin-left: 13px; background-color:black; border:none; border-radius:3px;"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>

	 	<div><a href="../photographer/form.php" style="color: #00acff;">Register</a> as Photo/Videographer, be a member of Photography Zone.</div>
