...
<html lang="en">
<head>
	<title>Login for Photography Zone</title>
	<meta charset="UTF-8">
...
<body>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100" style="padding-top: 90px!important;">
				...
				<form class="login100-form validate-form" action="process.php" method="post">
					...
					<div class="text-center p-t-24">
						<span class="txt1" style="font-size: 14px;">
							Forgot
						</span>
						<a class="txt2" href="#" style="font-size: 14px;">
							Username / Password?
						</a>
					</div>

					<div class="text-center p-t-110">
						<a class="txt2" href="form.php" style="font-size: 16px;">
							Create your Account
